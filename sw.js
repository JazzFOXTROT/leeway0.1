/* =========================================================================
   ...
   >>>   v7  הדרכת כניסה ראשונה בת שלושה שלבים במסך הבית, והמפתח
   >>>       leeway.onboarded
   >>>   v8  תיקון ההדרכה: הגיליון מתמקם מעל היעד במקום לדחוף את עמודת
   >>>       התוכן (כרטיס הסטטוס היה מוסתר מאחוריו), ההדגמה המופשטת
